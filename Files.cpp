...
namespace Files
{
	...
	namespace Read
	{
		...
		void ESP ( )
		{
			...
			FILE_READ_INT(g_Vars.ESP.ScreenESP, "ESP", "|ESP.Player.ScreenESP");
			...
			FILE_READ_INT(g_Vars.ESP.SoundRandomColor, "ESP", "|ESP.SoundRandomColor");
	...
	namespace Write
	{
		...
		void ESP ( )
		{
			...
			FILE_WRITE_INT(g_Vars.ESP.ScreenESP, "ESP", "|ESP.Player.ScreenESP");
			...
			FILE_WRITE_INT(g_Vars.ESP.SoundRandomColor, "ESP", "|ESP.SoundRandomColor");
	...
	void CreateFileVisuals ( )
	{
		...
		Visuals << "|ESP.Player.ScreenESP = 1" << std::endl;
		...
		Visuals << "|ESP.Sound = 1" << std::endl;
		Visuals << "|ESP.SoundRandomColor = 1" << std::endl;
