...
namespace Client
{
	...
	void Initialize ( )
	{
		...
		{
		//	SDK::Interfaces::g_pEngine->pfnCvar_Set ( "cl_crosshair_translucent", "0" );
		//	SDK::Interfaces::g_pEngine->pfnCvar_Set ( "cl_crosshair_color", "0" );
		}

		SDK::Interfaces::g_pEngine->pfnClientCmd ( "toggleconsole" );

		ConsolePrintColor(255, 0, 255, g_Vars.Main.Language == ENGLISH ? "\t\tPasteware pizdec nahui blyat :3\n " : "123");
